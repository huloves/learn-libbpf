//gcc ./perf_execve.c -o perf_execve
#include <linux/bpf.h>
#include <stdio.h>
#include <unistd.h>
...
//保存BPF程序
struct bpf_insn bpf_prog[0x1000];
...
int main(int argc, char **argv)
{
	...
	attr.config = 721;  // 观测进入execve的事件, 来自于: /sys/kernel/debug/tracing/events/syscalls/sys_enter_execve/id

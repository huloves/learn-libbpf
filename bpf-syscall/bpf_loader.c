...
#include "/home/huloves/linux-src/linux-5.15.136/samples/bpf/bpf_insn.h"
...
int bpf_prog_load(enum bpf_prog_type type, const struct bpf_insn* insns, int insn_cnt, const char* license)
{
	union bpf_attr attr = {
		...
		.license = ptr_to_u64(license),    //指向license字符串的指针
